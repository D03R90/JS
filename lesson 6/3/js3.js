 ...
 * @property {string} settings.openedImageNextBtnClass  Класс до картинки со стрелкой вправо.
 * @property {string} settings.openedImageBackBtnSrc Путь до картинки со стрелкой влево.
 * @property {string} settings.openedImageBackBtnClass  Класс до картинки со стрелкой влево.
 * @property {string} settings.openedImageErrorSrc  Путь до картинки - заглушки.
 */
const gallery = {
  openedImageEl:null,
  ...
  settings: {
    ...
    openedImageBackBtnClass:'galleryWrapper__back',
	  openedImageErrorSrc: 'images/error.jpg',
  },
   ...
   */
  openImage(src) {
    //Проверка на корректную загрузку картинки.
    ...
    img.onerror = () => openedImageEl.src = this.settings.openedImageErrorSrc;
    img.src = src;
    // Получаем контейнер для открытой картинки, в нем находим тег img и ставим ему нужный src.
  },
  ...
  createScreenContainer() {
    ...
    // Создаем картинку со стрелкой влево.
    ...
    //getPrevImage - функция, которая получает следующую картинку.
    ...
    //Проверка на корректную загрузку картинки.
    //image.onerror = () => image.src = this.settings.openedImageErrorSrc;
  ...
  /**
   * Возвращать следующий элемент (картинку) от открытой или первую картинку в контейнере,
   * если текущая открытая картинка последняя.
   * @returns {Element} Следующая картинка от текущей открытой.
   */
  getNextImage() {
  ...
  /**
   * Возвращать предыдущий элемент (картинку) от открытой или последнюю картинку в контейнере,
   * если текущая открытая картинка первая.
   * @returns {Element} Предыдущая картинка от текущей открытой.
   */
  getPrevImage() {
